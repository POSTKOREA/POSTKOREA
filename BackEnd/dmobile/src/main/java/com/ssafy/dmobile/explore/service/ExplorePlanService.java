...
public class ExplorePlanService {
    ...
    @Transactional
    public ExplorePlan createPlan(Long memberId, ExplorePlan explorePlan) {
        explorePlan.setMemberId(memberId);
        return explorePlanRepository.save(explorePlan);
    }

    @Transactional
    public ExplorePlan updatePlan(Long planId, Long memberId, ExplorePlan explorePlanDetails) {
        ...
        if (!Objects.equals(explorePlan.getMemberId(), memberId)) {
    ...
    public List<ExplorePlan> getOngoingPlans(Long memberId) {
        return explorePlanRepository.findOngoingPlans(memberId, new Date());
    }

    public List<ExplorePlan> getUpcomingPlans(Long memberId) {
        return explorePlanRepository.findUpcomingPlans(memberId, new Date());
    }

    public List<ExplorePlan> getCompletedPlans(Long memberId) {
        return explorePlanRepository.findCompletedPlans(memberId, new Date());
    }
}
